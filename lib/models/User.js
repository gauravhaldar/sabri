...
const userSchema = new mongoose.Schema(
  {
    ...
    phone: {
      ...
      validate: {
        validator: function (v) {
          ...
          if ((this.registeredBy === "google" || this.registeredBy === "firebase" || this.firebaseUid) && !v) {
        ...
        message: "Please enter a valid phone number (E.164 format, e.g., +91XXXXXXXXXX)",
      },
    },
    googleId: {
      type: String,
    ...
    firebaseUid: { // New field to store Firebase Phone Auth UID
      type: String,
      unique: true,
      sparse: true,
      index: true,
