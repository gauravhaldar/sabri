    ...
    <div className="min-h-screen bg-white pt-40 pb-14">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-6 flex items-end justify-between">
          <h1 className="text-2xl md:text-3xl font-semibold text-black">FAQ's</h1>
          <p className="text-xs text-gray-600">Quick answers • less scrolling</p>
        </div>
        ...
        <div className="mt-6 text-xs text-gray-700">Need more help? email support@sabri.com</div>
      </div>
    </div>
  );
}
