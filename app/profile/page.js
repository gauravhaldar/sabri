                ...
                {activeTab === "orders" && (
                  <div className="space-y-6">
                    ...
                    <div className="text-center py-12">
                      ...
                      <a href="/best-sellers" className="inline-block mt-4 px-4 py-2 bg-neutral-900 text-white rounded-md hover:opacity-90">
                        Start Shopping
                      </a>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between py-3 border-b border-neutral-200">
                        <div>
                          ...
                          <p className="text-sm text-neutral-600">Receive updates about your orders and promotions</p>
                        </div>
