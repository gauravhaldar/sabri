          ...
          <div className="flex h-full w-full items-end justify-start">
            ...
            <p className="mt-2 sm:mt-3 text-sm sm:text-base md:text-lg text-white/90">Discover the new Sabri collection</p>
              ...
              <div className="mt-5 sm:mt-6">
                <a href="#" className="inline-block rounded-md bg-[#6b4f3a] px-5 py-2.5 sm:px-6 sm:py-3 text-sm font-medium text-white shadow-sm hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-white/40">
                  Discover more
                </a>
              </div>
            </div>
