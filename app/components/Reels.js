  ...
  return (
    <section className="mt-6 sm:mt-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-normal text-neutral-900 mb-3 sm:mb-3.5 text-center flex items-center justify-center gap-2">
          Follow us on 
