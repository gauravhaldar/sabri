...
const products = [
  ...
  },
  {
    ...
    isOnSale: true,
    rating: 4.8,
    description: "Classic gold chain necklace for everyday wear",
  },
  {
    id: "n3",
  ...
  },
  {
    ...
    isOnSale: true,
    rating: 4.7,
    description: "Trendy silver layered necklace set",
  },
];
...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    <div className="bg-white group">
      <Link href={`/necklaces/${product.id}`} className="block">
...
export default function NecklacesPage() {
  ...
  const baseProducts = products.filter((product) => product.category === "Necklaces");
      ...
      <div className="bg-gray-50 py-8 pt-40">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-black mb-2">Necklaces</h1>
