                ...
                {expandedSections.returns && (
                  <div className="mt-3 text-sm text-gray-600 leading-relaxed space-y-2">
                    ...
                    <p>
                      ...
                      Issue – Exchange with same item; if unavailable, we’ll
                      assist with the closest variant or refund.
                    </p>
                  </div>
                )}
              </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="px-2 py-2">
                      <div className="line-clamp-1 text-sm text-neutral-900">
                        {rp.name}
                      </div>
