        ...
        <div className="flex items-center justify-between mb-8">
          ...
          {wishlistCount > 0 && (
            <button
              ...
              disabled={isClearing}
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-red-600 transition-colors disabled:opacity-50"
            >
                ...
                <div key={productId} className="bg-white group relative">
                  ...
                  <div className="p-4">
                    <Link href={`/${item.category}/${item.slug || productId}`}>
                      <h3 className="text-sm font-light text-black mb-2 line-clamp-2 leading-tight hover:text-gray-600 transition-colors">
                        {item.name}
                      </h3>
                    </Link>
