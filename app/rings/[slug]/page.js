...
const products = [
  {
    ...
    isBestSeller: true,
    rating: 5,
    description: "Elegant golden ring with leaf curve design",
  },
  {
    id: "6",
    name: "Golden Loop Flow Ring",
    price: 3499,
    originalPrice: 4999,
    discount: 30,
    image:
    ...
    category: "Rings",
    isOnSale: true,
    description: "Sophisticated golden ring with loop flow design",
  },
  {
    id: "7",
    name: "Braided Arc Golden Ring",
    price: 3219,
    originalPrice: 4599,
    discount: 30,
    image:
    ...
    category: "Rings",
    isOnSale: true,
    description: "Unique braided arc design in golden finish",
  },
  {
    id: "8",
    name: "Echo Wave Dual Tone Ring",
    price: 2169,
    originalPrice: 3099,
    discount: 30,
    image:
    ...
    category: "Rings",
    isOnSale: true,
    description: "Modern dual-tone ring with echo wave pattern",
  },
  {
    id: "9",
    name: "Silver Teardrop Sculpt Ring",
    price: 2764,
    originalPrice: 3949,
    discount: 30,
    image:
    ...
    category: "Rings",
    isOnSale: true,
    description: "Artistic silver ring with teardrop sculpt design",
  },
  {
    id: "10",
    name: "Fusion Drop Dual Tone Ring",
    price: 3079,
    originalPrice: 4399,
    discount: 30,
    image:
    ...
    category: "Rings",
    isOnSale: true,
    description: "Fusion design ring with dual-tone finish",
  },
];
      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-4 py-16 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/rings" className="text-blue-600 hover:underline">
              Back to Rings
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 pb-6">
              {(images[1] ? images : [product.image, product.image, product.image]).map((src, index) => (
                <button
                  key={index}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-0 mt-8">
                ...
                {expandedSections.description && (
                  <div className="mt-3">
                    <p className="text-sm text-gray-600 leading-relaxed">
                      {product.description ||
                        "Shine brighter this festive season with this elegant ring. Curated for those who love a perfect balance of glamour and grace, this item reflects brilliance in every detail."}
                    </p>
                  </div>
                )}
              </div>
              <div className="bg-gray-50 p-4 rounded-md">
                <button onClick={() => toggleSection("supplier")} className="w-full flex items-center justify-between text-left">
                  <span className="text-sm font-medium text-gray-500">Supplier Information</span>
                  <div className="w-12 h-12 bg-black rounded flex items-center justify-center">{expandedSections.supplier ? (<Minus className="h-3 w-3 text-white" />) : (<Plus className="h-3 w-3 text-white" />)}</div>
                </button>
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                <button onClick={() => toggleSection("returns")} className="w-full flex items-center justify-between text-left">
                  <span className="text-sm font-medium text-gray-500">Return & Exchange Policy</span>
                  <div className="w-12 h-12 bg-black rounded flex items-center justify-center">{expandedSections.returns ? (<Minus className="h-3 w-3 text-white" />) : (<Plus className="h-3 w-3 text-white" />)}</div>
                </button>
            ...
            <div className="mt-6 bg-[#F1EEE4] p-4 rounded-lg">
              <div className="grid grid-cols-3 gap-3">
                <div className="aspect-square bg-white rounded-lg shadow-sm flex flex-col items-center justify-center text-center transition-all duration-300 hover:shadow-md hover:scale-105">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-neutral-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8"><path d="M12 2l7 4v6c0 5-3.5 9-7 10-3.5-1-7-5-7-10V6l7-4z" /><path d="M9 12l2 2 4-4" /></svg>
                  <span className="mt-2 text-[12px] font-medium leading-snug text-neutral-900">Lifetime Warranty</span>
                </div>
                <div className="aspect-square bg-white rounded-lg shadow-sm flex flex-col items-center justify-center text-center transition-all duration-300 hover:shadow-md hover:scale-105">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-neutral-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8"><path d="M12 22s8-4 8-12A8 8 0 0 0 4 10c0 8 8 12 8 12z" /><path d="M9 11l2 2 4-4" /></svg>
                  <span className="mt-2 text-[12px] font-medium leading-snug text-neutral-900">Skin Safe Jewellery</span>
                </div>
                <div className="aspect-square bg-white rounded-lg shadow-sm flex flex-col items-center justify-center text-center transition-all duration-300 hover:shadow-md hover:scale-105">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 text-neutral-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8"><path d="M12 2l3 5 6 .9-4.5 4.4 1 6-5.5-3-5.5 3 1-6L3 7.9 9 7l3-5z" /></svg>
                  <span className="mt-2 text-[12px] font-medium leading-snug text-neutral-900">18k Gold Tone Plated</span>
                </div>
              </div>
            </div>
          ...
          {activeProductsTab === "related" && relatedProducts.length > 0 && (
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {relatedProducts.map((rp) => (
                <Link key={rp.id} href={`/rings/${rp.id}`} className="group border border-neutral-200">
          ...
          {activeProductsTab === "recent" && recentProducts.length > 0 && (
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {recentProducts.map((rv) => (
                <Link key={rv.id} href={`/rings/${rv.id}`} className="group border border-neutral-200">
                  <div className="relative aspect-square overflow-hidden">
