...
const productData = {
  m1: {
    ...
    reviews: 98,
    description:
      "Classic men's gold chain for sophisticated style. Perfect for formal and casual wear.",
    features: [
      "18K Gold",
      "Adjustable Length",
      "Tarnish Resistant",
  ...
  m2: {
    ...
    reviews: 76,
    description:
      "Elegant men's silver ring with modern design. Crafted for the contemporary gentleman.",
    features: [
      "925 Sterling Silver",
      "Handcrafted",
      "Hypoallergenic",
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/mens" className="text-blue-600 hover:underline">
          ...
          {activeProductsTab === "related" && relatedProducts.length > 0 && (
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {relatedProducts.map((rp) => (
                <Link key={rp.id} href={`/mens/${rp.id}`} className="group border border-neutral-200">
          ...
          {activeProductsTab === "recent" && recentProducts.length > 0 && (
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {recentProducts.map((rv) => (
                <Link key={rv.id} href={`/mens/${rv.id}`} className="group border border-neutral-200">
