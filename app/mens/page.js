...
const products = [
  {
    ...
    isOnSale: true,
    rating: 4.8,
    description: "Classic men's gold chain for sophisticated style",
  },
  {
    id: "m2",
    ...
    isOnSale: true,
    rating: 4.7,
    description: "Elegant men's silver ring with modern design",
  },
  {
    id: "m3",
    ...
    isOnSale: true,
    rating: 4.9,
    description: "Premium men's gold bracelet for special occasions",
  },
  {
    id: "m4",
    name: "Men's Watch",
    ...
    isOnSale: true,
    rating: 4.8,
    description: "Luxurious men's watch with gold accents",
  },
];
...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    <div className="bg-white group">
      <Link href={`/mens/${product.id}`} className="block">
...
export default function MensPage() {
  ...
  const baseProducts = products.filter((product) => product.category === "Mens");
