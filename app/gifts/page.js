...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    <div className="bg-white group">
      <Link
        href={`/gifts/${product.slug || product._id || product.id}`}
        className="block"
      >
      ...
      <div className="p-3">
        <Link href={`/gifts/${product.slug || product._id || product.id}`}>
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-gray-50 py-6 sm:py-8 pt-28 sm:pt-40">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl font-bold text-black mb-2">Gifts</h1>
