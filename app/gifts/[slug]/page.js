...
const productData = {
  g1: {
    ...
    reviews: 145,
    description:
      "Premium luxury gift box with jewelry collection. Perfect for special occasions and celebrations.",
    features: [
      "Premium Packaging",
  ...
  g2: {
    ...
    reviews: 98,
    description:
      "Elegant anniversary gift set for special occasions. Celebrate your love with this beautiful collection.",
    features: [
      "Romantic Design",
      "Premium Materials",
          ...
          {activeProductsTab === "related" && relatedProducts.length > 0 && (
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {relatedProducts.map((rp) => (
                <Link key={rp.id} href={`/gifts/${rp.id}`} className="group border border-neutral-200">
          ...
          {activeProductsTab === "recent" && recentProducts.length > 0 && (
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {recentProducts.map((rv) => (
                <Link key={rv.id} href={`/gifts/${rv.id}`} className="group border border-neutral-200">
