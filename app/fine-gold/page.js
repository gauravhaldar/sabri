...
const products = [
  {
    ...
    isOnSale: true,
    rating: 5,
    description: "Premium 18K gold wedding ring with classic design",
  },
  {
    id: "fg2",
    ...
    isOnSale: true,
    rating: 4.9,
    description: "Luxurious gold chain necklace for special occasions",
  },
  {
    id: "fg3",
    ...
    isOnSale: true,
    rating: 4.8,
    description: "Elegant gold diamond earrings with brilliant stones",
  },
  {
    id: "fg4",
    ...
    isOnSale: true,
    rating: 4.9,
    description: "Premium gold bracelet set with matching pieces",
  },
];
...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    <div className="bg-white group">
      <Link href={`/fine-gold/${product.id}`} className="block">
      ...
      <div className="p-3">
        <Link href={`/fine-gold/${product.id}`}>
...
export default function FineGoldPage() {
  ...
  const baseProducts = products.filter((product) => product.category === "Fine Gold");
      ...
      <div className="bg-gray-50 py-8 pt-40">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-black mb-2">Fine Gold</h1>
