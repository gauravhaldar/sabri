          ...
          <div className="bg-gray-50 rounded-lg p-8">
              ...
              <div>
                ...
                <div className="space-y-2 text-gray-700">
                  ...
                  <p className="text-sm text-gray-600 mt-4">
                    We&apos;re open 7 days a week to serve you better. Visit us
                    anytime for a personalized jewelry shopping experience.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                Our flagship store in Koregaon Park offers an immersive jewelry
                experience with expert stylists, personalized consultations, and
                exclusive collections. Whether you&apos;re looking for everyday
                pieces or special occasion jewelry, our team is here to help you
                find the perfect pieces that reflect your unique style and
                personality.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Personalized styling sessions with our expert stylists",
                icon: "✨",
              },
              {
                title: "Jewelry Cleaning",
                description:
                  "Complimentary ultrasonic cleaning for all Sabri pieces",
                icon: "💎",
              },
              {
              ...
              },
              {
                title: "Gift Wrapping",
                description:
                  "Luxury gift wrapping and personalization services",
                icon: "🎁",
              },
            ].map((service, index) => (
              <div
